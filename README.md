...
4. Starter code is available in script.js.
...
Unless otherwise specified on the calendar or by an instructor, homework is due one week after it is assigned.

### Preview Next Week's Content

To prepare for next week's material, check out the following videos:
